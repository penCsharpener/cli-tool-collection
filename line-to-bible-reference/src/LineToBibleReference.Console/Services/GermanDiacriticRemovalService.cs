...
public sealed class GermanDiacriticRemovalService : IDiacriticRemovalService
{
    private static readonly CharacterReplacementModel[] _replacementList;

    static GermanDiacriticRemovalService()
    {
        _replacementList = Constants.GermanCharacterList
